...
$css = '
	...
	*{
	  ...
	  font-family:"helvetica",hevetica neue,sans-serif;
	  font-weight:300;
	  text-shadow:0 1px 1px rgba(0,0,0,.6),0 2px 2px rgba(0,0,0,.4)
	}
	#form{
	  width:220px;
	  margin:25vh auto;
	...
	#form footer p a{font-weight:600;text-decoration:none;color:#fff}
...
if(!$_SESSION['_sfm_allowed']) {
	echo '<html><head><style>'.$css.'</style></head><body>'.$login_form.'</body></html>';
	// sha1, and random bytes to thwart timing attacks.  Not meant as secure hashing.
	$t = bin2hex(openssl_random_pseudo_bytes(10));	
	if(($_POST['pass'] && sha1($t.$_POST['pass']) === sha1($t.$PASSWORD))&&($_POST['login'] == $LOGIN)) {
...
#top {height:52px;}
#mkdir {display:inline-block;float:right;padding-top:0px;}
...
<div id="top">
	...
	<a href="?do=logout" id="logout">LogOut</a>
